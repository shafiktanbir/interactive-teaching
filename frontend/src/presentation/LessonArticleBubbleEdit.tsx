    ...
    <>
      ...
      >
        <div className="lesson-bubble-menu" role="toolbar" aria-label="Selection actions">
          <button
            type="button"
            className="lesson-bubble-edit-primary"
            onClick={openPanel}
            aria-label="Edit selection with formatting"
            title="Edit (Ctrl+E)"
          >
            <span className="lesson-bubble-edit-label">Edit</span>
            <span className="lesson-bubble-edit-hint">Bold, italic, underline, links…</span>
          </button>
        </div>
      </BubbleMenu>
